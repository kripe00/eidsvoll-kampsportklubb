...
const fallbackOmOssData = {
  ...
  blocks: [
    ...
    },
    {
      ...
      description:
        "For oss er kampsport et verktøy for å bygge gode holdninger og sterke mennesker. Vår visjon er å være Eidsvolls mest inkluderende treningsmiljø basert på våre grunnverdier:",
      variant: "asymmetric",
      image: "/PXL_20260211_163724399.jpg",
      items: [
        {
